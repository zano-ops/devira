    ...
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', background: 'white', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <Section title="Article 1 — Objet">
          <p>Les présentes Conditions Générales de Vente et d'Utilisation (« CGV/CGU ») régissent l'accès et l'utilisation de la plateforme <strong>Devisly</strong>, service SaaS de génération de devis pour les artisans du BTP, accessible sur <strong>devisly.com</strong> (le « Service »).</p>
        ...
        <Section title="Article 2 — Éditeur du Service">
          <p><strong>Devisly</strong> est édité par une entreprise enregistrée en France.</p>
          <p style={{ marginTop: 8 }}>Contact : <a href="mailto:support@devisly.fr" style={{ color: A, textDecoration: 'none', fontWeight: 600 }}>support@devisly.fr</a></p>
        </Section>

        <Section title="Article 3 — Accès au Service et essai gratuit">
          <p>Devisly propose un accès gratuit de <strong>14 jours</strong> à l'ensemble des fonctionnalités, sans carte bancaire requise. À l'issue de cette période d'essai, la poursuite de l'utilisation du Service est conditionnée à la souscription d'un abonnement payant.</p>
        ...
        <Section title="Article 4 — Abonnements et tarifs">
          ...
          <p style={{ marginTop: 12 }}>Les prix sont indiqués hors taxes. La TVA applicable est celle en vigueur à la date de facturation. Devisly se réserve le droit de modifier ses tarifs avec un préavis de 30 jours. Les abonnements en cours ne sont pas affectés jusqu'à leur prochaine échéance.</p>
        </Section>

        <Section title="Article 5 — Facturation et paiement">
          <p>Le paiement s'effectue par carte bancaire via <strong>Stripe</strong>, prestataire de paiement sécurisé. Devisly ne stocke à aucun moment vos coordonnées bancaires.</p>
        ...
        <Section title="Article 6 — Politique de remboursement">
          <p>Devisly offre une <strong>garantie satisfait ou remboursé de 14 jours</strong> à compter du premier prélèvement. Pour en bénéficier, envoyez simplement un email à <a href="mailto:support@devisly.fr" style={{ color: A, textDecoration: 'none', fontWeight: 600 }}>support@devisly.fr</a> en indiquant votre demande de remboursement. Le remboursement sera effectué sous 5 à 10 jours ouvrés sur votre moyen de paiement d'origine.</p>
        ...
        <Section title="Article 8 — Propriété intellectuelle">
          <p>La plateforme Devisly, son interface, son code source, ses algorithmes et son contenu sont la propriété exclusive de Devisly et sont protégés par les lois françaises et internationales sur la propriété intellectuelle.</p>
          ...
          <p style={{ marginTop: 10 }}>Vous conservez l'entière propriété de vos données : devis, clients, catalogue de prestations, logos et tout contenu que vous créez via le Service. En utilisant le Service, vous accordez à Devisly une licence limitée d'utilisation de ces données dans le seul but de vous fournir le Service.</p>
        </Section>

        <Section title="Article 9 — Disponibilité et maintenance">
          <p>Devisly s'engage à maintenir le Service disponible <strong>99 % du temps</strong> sur une base mensuelle. Des interruptions de maintenance programmée peuvent avoir lieu, de préférence en dehors des heures ouvrées. En cas d'interruption imprévue significative, nous vous en informerons dans les meilleurs délais.</p>
        </Section>

        <Section title="Article 10 — Limitation de responsabilité">
          <p>Devisly est un outil d'aide à la création de devis. Les devis générés via l'IA sont fournis à titre indicatif et doivent être vérifiés par l'utilisateur avant tout envoi à un client. Devisly ne peut être tenu responsable des erreurs dans le contenu des devis, des litiges commerciaux entre l'utilisateur et ses clients, ou de toute perte de chiffre d'affaires liée à l'utilisation du Service.</p>
        ...
        <Section title="Article 11 — Données personnelles">
          <p>Le traitement de vos données personnelles est régi par notre <button onClick={() => navigate('/confidentialite')} style={{ background: 'none', border: 'none', color: A, fontWeight: 600, cursor: 'pointer', padding: 0, fontSize: 15, textDecoration: 'underline' }}>Politique de Confidentialité</button>, accessible à tout moment sur le Site. Devisly s'engage à traiter vos données conformément au Règlement Général sur la Protection des Données (RGPD).</p>
        </Section>

        <Section title="Article 12 — Droit applicable et litiges">
          <p>Les présentes CGV/CGU sont soumises au <strong>droit français</strong>. En cas de litige, et après tentative de résolution amiable, les tribunaux du ressort du siège social de Devisly seront seuls compétents.</p>
        ...
        <Section title="Article 13 — Modifications des CGV">
          <p>Devisly se réserve le droit de modifier les présentes CGV/CGU à tout moment. Vous serez informé de toute modification significative par email avec un préavis de 30 jours. La poursuite de l'utilisation du Service après ce délai vaut acceptation des nouvelles conditions.</p>
        </Section>
